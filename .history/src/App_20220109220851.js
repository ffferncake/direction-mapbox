  ...
  useEffect(() => {
    ...
    map.current.on("load", function () {
      map.current.addSource("hospital", {
        ...
        data: "https://data.thailand.opendevelopmentmekong.net/geoserver/ODThailand/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=ODThailand%3Aff9d089e-ac13-4691-8b4e-effd9be6adf5&outputFormat=application%2Fjson",
      });
