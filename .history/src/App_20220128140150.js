  ...
  useEffect(() => {
    ...
    async function getData() {
      ...
      map.current.on("idle", () => {
        ...
        const fsSourceId2 = "featureserver-src";
        const servicee = new FeatureService(fsSourceId2, map.current, {
          url: "https://gistdaportal.gistda.or.th/arcgis/rest/services/LayerList4/FeatureServer/16",
        });
