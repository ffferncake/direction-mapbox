...
import { layerControlSimple } from "./hook/layerControlSimple.js";
import { layerControlGrouped } from "../hook/layerControlGrouped.js";
    ...
    async function getData() {
      ...
      map.current.addControl(
        new layerControlSimple({
          layers: ["contours", "hospital", "trafficIncident"],
        }),
        "top-left"
      );
      map.current.on("idle", () => {
      ...
      //   map.current.addControl(
      //     new layerControlSimple({
      //       layers: ["contours", "trafficIncident", "hospital-layer"],
      //     }),
      //     "bottom-right"
      //   );
      // });
      map.current.on("idle", () => {
        ...
        //     !map.current.getLayer("trafficIncident") ||
