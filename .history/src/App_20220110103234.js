...
export default function App() {
  ...
  useEffect(() => {
    ...
    async function getData() {
      let traffic-incident = { type: "FeatureCollection", features: [] };
      await fetch(incident)
        ...
        .then((data) => {
          for (let point of data) {
            ...
            traffic-incident.features.push(feature);
            ...
            map.current.on("mouseenter", "traffic-incident", (e) => {
            ...
            map.current.on("mouseleave", "traffic-incident", () => {
      ...
      console.log(traffic-incident);
      // After the last frame rendered before the map enters an "idle" state.

      const obstacle = buffer(traffic-incident, 0.25, {
        units: "kilometers",
      });
      let bbox = [0, 0, 0, 0];
      ...
      map.current.on("load", function () {
        ...
        //   type: "raster",
        //   tiles: [
        //     "https://bmagis.bangkok.go.th/arcgis/rest/services/BMA/SafetyMap/MapServer/export?bbox=%7Bbbox-epsg-3857%7D&bboxSR=EPSG%3857&layers=5&layerDefs=&size=512%2c512&imageSR=&format=png&transparent=true&dpi=&time=&layerTimeOptions=&dynamicLayers=&gdbVersion=&mapScale=&f=image",
        //   ],
        //   tileSize: 512,
        // });
      ...
      map.current.on("idle", () => {
        ...
        map.current.on("idle", () => {
          ...
          if (
            ...
            !map.current.getLayer("traffic-incident") ||
            !map.current.getLayer("hospital")
          ) {
            return;
          }
        });
        // Enumerate ids of the layers.
        const toggleableLayerIds = ["contours", "traffic-incident", "hospital-layer"];
