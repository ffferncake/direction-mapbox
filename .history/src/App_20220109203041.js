    ...
    async function getData() {
      ...
      map.current.on("load", function () {
        ...
        map.current.addSource("wms-test-source", {
          type: "vector",
          tiles: [
            "https://bmagis.bangkok.go.th/arcgis/rest/services/BMA/SafetyMap/MapServer/export?bbox={bbox-epsg-4326}&bboxSR=EPSG%4326&layers=5size=256%2c256&format=geojson",
          ],
          tileSize: 256,
        });
