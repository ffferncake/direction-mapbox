...
export default function App() {
  ...
  useEffect(() => {
    ...
    //set zoom level change, Choropleth
    let zoomThreshold = 5;
    /************************************ mapbox switcher ******************************/
    ...
    async function getData() {
      ...
      function toggleLayer(ids, name) {
        var link = document.createElement("radio");
        link.href = "#";
        ...
        var inputs = layers.getElementsByTagName("layers");
    ...
    <div>
      ...
      <div class="rounded-toggle inline" id="toggle">
        <input
          ...
          type="radio"
          name="rtoggle"
          value="hospital-layer"
          checked="checked"
        />
        <label for="hospital-layer">Test A</label>
        <input id="contours" type="radio" name="rtoggle" value="contours" />
        <label for="contours">Test B</label>
      </div>
      {/* <!-- route report ----> */}
      <div class="sidebar">
        <h1>รายงานเส้นทาง</h1>
