...
export default function App() {
  ...
  useEffect(() => {
    ...
    //       type: "Feature",
    //       properties: {
    //         title: "ต.ด่านสวี อ.เมือง จ.ชุมพร",
    //       },
    //       geometry: {
    ...
    //       type: "Feature",
    //       properties: {
    //         title: "ต.ท่าตูม อ.เมืองมหาสารคาม จ.มหาสารคาม",
    //       },
    //       geometry: {
    //         coordinates: [103.484, 16.162],
    //         type: "Point",
    ...
    //       type: "Feature",
    //       properties: {
    //         title: "ต.อ่างทอง อ.เกาะสมุย จ.สุราษฎร์ธานี",
    //       },
    //       geometry: {
    ...
    async function forwardGeocoder(query) {
      ...
      await axios
        ...
        .then((data) => {
          for (let point of data) {
            let coordinate = [parseFloat(point.LONG), parseFloat(point.LAT)];
            ...
            console.log(customData.features.push(feature))
          }
          return customData;
        });
      ...
      for (const feature of customData.features) {
        ...
        if (
          feature.properties.TAMBON_T.toLowerCase().includes(
            query.toLowerCase()
          )
        ) {
          ...
          feature["place_name"] = `🌲 ${feature.properties.TAMBON_T}`;
    ...
    async function getData() {
      ...
      toggleLayer2(["school-circle"], "โรงเรียน");
