...
export default function App() {
  ...
  useEffect(() => {
    ...
    async function getData() {
      ...
      if (!map.current.getLayer("contours") || !map.current.getLayer("hospital-layer")) {
        return;
      }

      // Enumerate ids of the layers.
      const toggleableLayerIds = ["contours", "hospital-layer"];
