    ...
    async function getData() {
      ...
      map.current.on("load", function () {
        ...
        map.current.addSource("wms-test-source", {
          ...
          tiles: [
            "https://bmagis.bangkok.go.th/arcgis/rest/services/BMA/SafetyMap/MapServer/export?bbox={bbox-epsg-3857}&bboxSR=EPSG%3A3857&layers=5&layerDefs=&size=256%2c256&imageSR=&format=png&transparent=true&dpi=&time=&layerTimeOptions=&dynamicLayers=&gdbVersion=&mapScale=&f=image",
          ],
          tileSize: 256,
        });
