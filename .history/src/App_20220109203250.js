    ...
    async function getData() {
      ...
      map.current.on("load", function () {
        ...
        map.current.addSource("wms-test-source", {
          type: "vector",
          tiles: [
            "https://bmagis.bangkok.go.th/arcgis/rest/services/BMA/SafetyMap/MapServer/export?bbox=%7Bbbox-epsg-4326%7D&bboxSR=EPSG%4326&layers=5&layerDefs=&size=512%2c512&imageSR=&format=png&transparent=true&dpi=&time=&layerTimeOptions=&dynamicLayers=&gdbVersion=&mapScale=&f=image",
          ],
          tileSize: 512,
        });
