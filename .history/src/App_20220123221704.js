...
export default function App() {
  ...
  useEffect(() => {
    ...
    function forwardGeocoder(query) {
      ...
      fetch("https://data.opendevelopmentmekong.net/dataset/ab20b509-2b7f-442e-8448-05d3a17651ac/resource/76253a1a-b472-4d64-b209-0ea3114f51f4/download/thailand_health_facilities_th.geojson", {
        headers: {
        ...
        .then((data) => {
          ...
          data.features.forEach((feature) => {
            if (
              feature.properties.Agency.toLowerCase().search(
                query.toLowerCase()
              ) !== -1
            ) {
              feature["place_name"] = "🌲 " + feature.properties.Agency;
              feature["center"] = feature.geometry.coordinates;
              feature["adress"] = feature.properties.Address;
