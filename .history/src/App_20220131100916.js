...
export default function App() {
  ...
  useEffect(() => {
    ...
    getSchool();
    const schoolUrl =
      "https://geoportal.rtsd.mi.th/arcgis/rest/services/OpenData/TH_AdminOffice/FeatureServer/0/query?where=1%3D1&f=geojson";
