    ...
    async function getData() {
      ...
      map.current.on("load", function () {
        ...
        map.current.addSource("wms-test-source", {
          ...
          tiles: [
            "https://bmagis.bangkok.go.th/arcgis/rest/services/BMA/SafetyMap/MapServer/5?bbox={bbox-epsg-4326}&format=image/png&service=WMS&version=1.3.0&request=GetMap&CRS=EPSG:4326&transparent=true&width=256&height=256&layer=0",
          ],
          tileSize: 256,
        });
