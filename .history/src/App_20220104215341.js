          ...
          for (let point of data) {
            ...
            map.current.on("mouseenter", "mygeojson", (e) => {
              ...
              popup
                ...
                .setHTML(
                  `<div id = "popup-container"><table><h3 style="text-align:center"; font-family: "Noto Sans Thai", sans-serif;><td>ชื่อ<tr>${properties.title}</tr><td><td>${properties.title_en}</td></h3><table></div>`
                )
                .addTo(map.current);
            });
