...
export default function App() {
  ...
  useEffect(() => {
    ...
    function forwardGeocoder(query) {
      const hos = "../src/data/hospital.geojson";
      for (const feature of hos.features) {
        const customData = {
          features: [
            {
              type: "Feature",
              properties: {
                title: `${feature.properties.NAME_T}`,
              },
              geometry: {
                coordinates: `${hos.features.geometry.coordinates}`,
                type: "Point",
              },
            },
          ],
        ...
        for (const feature of customData.features) {
          ...
          if (
            ...
            feature["place_name"] = `🌲 ${feature.properties.NAME_T}`;
