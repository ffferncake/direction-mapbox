        ...
        .then((data) => {
          for (let point of data) {
            ...
            map.current.on("mouseenter", "mygeojson", (e) => {
              ...
              const img = e.features[0].properties['images'];
              const id = e.features[0].properties.eid;
              ...
              popup
                .setLngLat(coordinates)
                .setHTML(
                  `<div id = "popup-container"><h2>${title}</h2><h4>${description}</h4><img src = ${img} id=${id}/></div>`
                )
                .addTo(map.current);
            });
