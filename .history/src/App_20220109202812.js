    ...
    async function getData() {
      ...
      map.current.on("load", function () {
        ...
        map.current.addSource("wms-test-source", {
          type: "vector",
          tiles: [
            "https://bmagis.bangkok.go.th/arcgis/rest/services/BMA/SafetyMap/MapServer/export?bbox={bbox-epsg-32647}&bboxSR=EPSG%3A32647&layers=5size=256%2c256&format=json",
          ],
          tileSize: 256,
        });
